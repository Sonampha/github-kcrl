            ...
            <div class="container">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                        <div class="single-footer-widget footer-about">
                            <h3>Address</h3>
                            <ul>
                                <li><i class="fa fa-phone"></i> <a href="callto:+85593888823">+855(0)93-8888-23</a></li>
                                <li><i class="fa fa-envelope"></i> <a href="mailto:chhor.sokhavady@kcairlines.com">chhor.sokhavady@kcairlines.com</a></li>
                                <li><i class="fa fa-map-marker"></i> Russian Blvd, Phnom Penh 12406</li>
                                <li><i class="fa fa-calendar"></i> 8:00 AM - 5:30 PM (Mon to Fri)</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                        <div class="single-footer-widget twitter-widget">
                            <h3>About Us</h3>
                            <p>We offer you safety, trust, and especially transport services at the highest levels. 
                            Our drivers, professionals by definition, come to meet your demands with maximum responsibility. 
                            Safety and punctuality always come first.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
